...
const AdminLayout = ({ children, title = 'Dashboard' }) => {
  ...
  // Efecto separado para las notificaciones que se ejecuta siempre
  useEffect(() => {
    // Cargar notificaciones inmediatamente al montar el componente
  ...
  // Actualizar notificaciones cuando cambia la ruta
  useEffect(() => {
    cargarNotificaciones();
  }, [location.pathname]);
  ...
  const cargarNotificaciones = async () => {
    try {
      console.log('🔔 Cargando notificaciones...', new Date().toLocaleTimeString());
      ...
      // Marcar como leídas las que ya fueron leídas
      ...
      console.log(`✅ Notificaciones actualizadas: ${notificacionesActualizadas.length} total, ${noLeidas} no leídas`);
    } catch (e) {
